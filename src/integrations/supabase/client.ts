...
// Chave Pública VAPID para Web Push Notifications (ATUALIZE COM SUA NOVA CHAVE PÚBLICA)
export const VAPID_PUBLIC_KEY = "BBvdrgRj6LYrCwS1KfmKTiI_A8XKYS8dInOqQqB8ZFaSD5yJdwBK8_gWW4sfcL9rBzRT4Mtd_0Nu8JQRcDCMeZcI"; // Chave VAPID atualizada
