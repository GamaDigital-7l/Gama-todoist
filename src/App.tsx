...
import { persistQueryClient } from "@tanstack/query-persist-client/build/lib"; // Updated import path
import { createSyncStoragePersister } from "@tanstack/query-sync-storage-persister/build/lib"; // Updated import path
