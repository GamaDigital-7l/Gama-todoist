...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4 md:p-6 lg:p-8"> {/* Ajustado padding */}
      <div className="w-full max-w-md bg-card p-4 sm:p-8 rounded-lg shadow-lg border border-border">
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-6 text-foreground">Entrar ou Cadastrar</h2> {/* Fontes adaptáveis */}
        <Auth
