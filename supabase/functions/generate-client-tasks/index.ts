...
import { format, getWeek, getDay, addDays, startOfMonth, endOfMonth, isSameDay, parseISO, addDays as dateFnsAddDays } from "https://esm.sh/date-fns@3.6.0"; // Versão atualizada
