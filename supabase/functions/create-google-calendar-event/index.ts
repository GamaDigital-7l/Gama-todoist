...
import { addMinutes, formatISO } from "https://esm.sh/date-fns@3.6.0"; // Versão atualizada
  ...
  try {
    ...
    const event = {
      ...
      start: {
        ...
        timeZone: profile.timezone || 'America/Sao_Paulo', // Usar fuso horário do perfil ou fallback
      },
      end: {
