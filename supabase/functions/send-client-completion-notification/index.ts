...
import { ptBR } from "https://esm.sh/date-fns@3.6.0/locale/pt-BR"; // Versão e caminho corrigidos
...
serve(async (req) => {
  ...
  try {
    ...
    const monthName = format(utcToZonedTime(parseISO(`${monthYearRef}-01`), userTimezone), "MMMM yyyy", { locale: ptBR });
